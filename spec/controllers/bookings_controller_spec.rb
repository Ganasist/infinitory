  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved booking as @booking" do
        ...
        post :create, {:booking => { "title" => "invalid value" }}, valid_session
        expect(assigns(:booking)).to be_a_new(Booking)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested booking" do
        ...
        expect_any_instance_of(Booking).to receive(:update).with({ "title" => "MyString" })
        put :update, {:id => booking.to_param, :booking => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the booking as @booking" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Booking).to receive(:save).and_return(false)
        put :update, {:id => booking.to_param, :booking => { "title" => "invalid value" }}, valid_session
        expect(assigns(:booking)).to eq(booking)
      end
